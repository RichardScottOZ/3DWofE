# Variance resulting from membership function
# -------------------------------------------
import csv
import itertools
...
# P(B)
input_file = open("/data/3DWofE_fuzzy_variance/NumB.csv")
input_reader = csv.reader(input_file)
output_file = open("/results/ProB.csv", "wb")
...
input_file = open("/data/3DWofE_fuzzy_variance/NumB.csv")
input_reader = csv.reader(input_file)
output_file = open("/results/ProB_abs.csv", "wb")
output_writer = csv.writer(output_file)
ProB_abs_temp = []
for row in input_reader:
    for i in range(num_fac):
...
# P(D|B)
input1_file = open("/data/3DWofE_fuzzy_variance/NumB.csv")
input1_reader = csv.reader(input1_file)
input2_file = open("/data/3DWofE_fuzzy_variance/NumBD.csv")
input2_reader = csv.reader(input2_file)
output_file = open("/results/ProDB.csv", "wb")
output_writer = csv.writer(output_file)
ProDB_temp = []
...
input1_file = open("/data/3DWofE_fuzzy_variance/NumB.csv")
input1_reader = csv.reader(input1_file)
input2_file = open("/data/3DWofE_fuzzy_variance/NumB_absD.csv")
input2_reader = csv.reader(input2_file)
output_file = open("/results/ProDB_abs.csv", "wb")
output_writer = csv.writer(output_file)
ProDB_abs_temp = []
for row1, row2 in itertools.izip(input1_reader, input2_reader):
    for i in range(num_fac):
...
# Var[P(D)]
input1_file = open("/results/ProB.csv")
input1_reader = csv.reader(input1_file)
input2_file = open("/results/ProB_abs.csv")
input2_reader = csv.reader(input2_file)
input3_file = open("/results/ProDB.csv")
input3_reader = csv.reader(input3_file)
input4_file = open("/results/ProDB_abs.csv")
input4_reader = csv.reader(input4_file)
output_file = open("/results/Var_ProD.csv", "wb")
output_writer = csv.writer(output_file)
Var_ProD_temp = []
...
# The variance caused by mis-assigned evidence from B to B_abs or from B_abs to B
# Var[P(D)]_B to B_abs
input1_file = open("/results/ProB.csv")
input1_reader = csv.reader(input1_file)
input2_file = open("/results/ProDB.csv")
input2_reader = csv.reader(input2_file)
input3_file = open("/results/ProDB_abs.csv")
input3_reader = csv.reader(input3_file)
output_file = open("/results/Var_ProD_B.csv", "wb")
output_writer = csv.writer(output_file)
Var_ProD_B_temp = []
...
# Var[P(D)]_B_abs to B
input1_file = open("/results/ProB_abs.csv")
input1_reader = csv.reader(input1_file)
input2_file = open("/results/ProDB.csv")
input2_reader = csv.reader(input2_file)
input3_file = open("/results/ProDB_abs.csv")
input3_reader = csv.reader(input3_file)
output_file = open("/results/Var_ProD_B_abs.csv", "wb")
output_writer = csv.writer(output_file)
Var_ProD_B_abs_temp = []
for row1, row2, row3 in itertools.izip(input1_reader, input2_reader, input3_reader):
    for i in range(num_fac):
...
input2_file = open("/results/ProB_abs.csv")
input2_reader = csv.reader(input2_file)
input3_file = open("/data/3DWofE_fuzzy_variance/Fuzzy Contrast.csv")
input3_reader = csv.reader(input3_file)
output_file = open("/results/Pro_FC_B.csv", "wb")
output_writer = csv.writer(output_file)
Pro_FC_B_temp = []
for row1, row2, row3 in itertools.izip(input1_reader, input2_reader, input3_reader):
    for i in range(num_fac):
...
input1_file = open("/data/3DWofE_fuzzy_variance/Fuzzy Contrast.csv")
input1_reader = csv.reader(input1_file)
input2_file = open("/results/Pro_FC_B.csv")
input2_reader = csv.reader(input2_file)
input3_file = open("/results/Var_ProD.csv")
input3_reader = csv.reader(input3_file)
output_file = open("/results/Var_ProD_FC_B.csv", "wb")
output_writer = csv.writer(output_file)
Var_ProD_FC_temp = []
for row1, row2, row3 in itertools.izip(input1_reader, input2_reader, input3_reader):
    for i in range(num_fac):
